...
<body class="d-flex flex-column min-vh-100">
    <!-- Admin Header -->
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(90deg,#673ab7 0%, #8e24aa 100%);">
        ...
        <div class="row g-0">
            <div class="col-12 col-md-2 col-lg-2 layout-sidebar p-0 sidebar-wrap">
                <div class="list-group list-group-flush">
                    <a href="/admin" class="list-group-item list-group-item-action">🏠 Trang chủ</a>
                    <a href="/admin/categories" class="list-group-item list-group-item-action">📂 Quản lý danh mục</a>
                    <a href="/admin/videos" class="list-group-item list-group-item-action">🎬 Quản lý video</a>
                    <a href="/admin/users" class="list-group-item list-group-item-action">👥 Quản lý người dùng</a>
                    <a href="/admin/profile" class="list-group-item list-group-item-action">👤 Thông tin cá nhân</a>
                </div>
            </div>
    ...
    <footer class="text-light text-center py-3 mt-auto" style="background: linear-gradient(90deg,#673ab7 0%, #8e24aa 100%);">
        <small>Admin Area - Video Manager System</small>
    </footer>
