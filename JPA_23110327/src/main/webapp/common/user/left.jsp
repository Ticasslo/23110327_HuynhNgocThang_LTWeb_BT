...
<div class="list-group list-group-flush">
  ...
  <a href="${pageContext.request.contextPath}/user/profile" class="list-group-item list-group-item-action${fn:endsWith(pageContext.request.requestURI, '/user/profile') ? ' active' : ''}">👤 Thông tin cá nhân</a>
</div>
