...
<body>
    ...
    <!-- Header -->
    <div class="header">
        <h1>🛒 <strong>Seller Panel</strong></h1>
        <div class="user-info">
            <div class="user-name">👤 ${sessionScope.account.fullName}</div>
            <div class="user-role">@${sessionScope.account.userName} • Seller</div>
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="welcome-card">
                <h2>🎉 Chào mừng đến với Seller Panel</h2>
                <p>Quản lý cửa hàng và tăng doanh thu bán hàng của bạn.</p>
